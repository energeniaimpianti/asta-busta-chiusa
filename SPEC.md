...
| D2 | Pareggio sull'offerta massima | **SPAREGGIO UNICO** ristretto ai pari-merito: busta OBBLIGATORIA, minimo = **la propria puntata** (ripeterla è consentito, scendere no), nessun ritiro; **un secondo pareggio, a qualunque importo, decide il SORTEGGIO automatico** (monetina con 2, pesca con 3+; il vincitore paga l'importo pareggiato) | regola definitiva della lega (07/09/2026): niente spareggi a catena, la monetina chiude subito; deterministica |
